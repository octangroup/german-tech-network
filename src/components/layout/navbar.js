...
class Navbar extends React.Component {
  ...
  render() {
    return (
      <nav className="fixed z-9999 text-accent h-rem-20 w-100 hidden xl:block lg:block m-0 t-0">
        <div className="w-90 relative flex mx-auto py-10 mx-0">
          <div className="w-20 flex list my-auto mx-0 px-0 ">
            <div className="m-0 w-30 px-0 py-1">
              <Link to="/">
                <img src={"/img/Tech_logo.svg"} alt="GERMAN RWANDAN TECH NETWORK"/>
              </Link>
            </div>
            ...
            {/* <li className="m-0 px-0 py-1">
              <Link to="/" className="logo-font text-base w-20 text-primary">
